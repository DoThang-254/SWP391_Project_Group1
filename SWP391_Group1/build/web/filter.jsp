            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="readwarrantyinformation">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="filter-section">
                                    <form action="filter" method="post" class="row">
                                        <!-- Filter Product Name -->
                                        <div class="col-md-3">
                                            <label for="filterProductName">Product Name</label>
                                            <input type="text" name="filterProductName" id="filterProductName" class="form-control"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="filterPriceRange" id="filterPriceRange" class="form-control"
                                        ...
                                        <div class="col-md-12 text-right mt-3">
                                            ...
                                            <a href="searchwarrantyinformation" class="btn btn-secondary">
                                ...
                                <div class="panel-body table-responsive">
                                    <div class="box-tools m-b-15">
                                        <form action="searchwarrantyinformation" method="get" class="input-group">
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                <th>Product ID
                                                    <a href="?sort=productId&order=asc"><i class="fa fa-arrow-up"></i></a>
                                                    <a href="?sort=productId&order=desc"><i class="fa fa-arrow-down"></i></a>
                                                </th>
                                                <th>Product Name
                                                    <a href="?sort=productId&order=asc"><i class="fa fa-arrow-up"></i></a>
                                                    <a href="?sort=productId&order=desc"><i class="fa fa-arrow-down"></i></a>
                                        ...
                                        <c:forEach var="c" items="${requestScope.listA}">
                                            <tr>
                                                ...
                                                <td>${c.buyTime}</td>
                                                <td>
                                                    <a href="viewProductDetails?productId=${c.productId}" class="btn btn-info btn-sm"
                                                       title="View Details">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                </td>
                                            ...
                                            <c:forEach begin="1" end="${requestScope.endpage}" var="i">
                                                <li>
                                                    <a class="${tag == i ? 'active' : ''}"
                                                       href="filter?index=${i}&filterBrand=${requestScope.brand}">${i}</a>
                                                </li>
                                            </c:forEach>
                                        </ul>
                                    </div>
